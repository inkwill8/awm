...
marvel = ['Tony Stark', 'Steve Rogers', 'Bruce Banner', 'Natasha Romanoff', 'Clint Barton', 'Thor Odinson',
          'Wanda Maximoff', 'Vision', 'Peter Parker', 'Miles Morales']
sherlock_holmes = ['Sherlock Holmes', 'John Watson', 'Molly Hooper', 'Mycroft Holmes', 'Sherlock Holmes',
                   'James Moriarty', 'John Watson', 'Irene Adler']
